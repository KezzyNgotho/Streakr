  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center mb-4">
        <div className="bg-white rounded-lg shadow-md p-4 flex flex-col items-center w-full max-w-xs mx-auto border border-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {/* Quick Links */}
        <div className="bg-white rounded-lg shadow-md p-4 flex flex-col gap-3 border border-primary/20 w-full max-w-md mx-auto">
        ...
        {/* Tips & Motivation */}
        <div className="bg-white rounded-lg shadow-md p-4 flex flex-col gap-3 border border-secondary/20 w-full max-w-md mx-auto">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xl">💡</span>
        ...
        {/* Recent Activity */}
        <div className="bg-white rounded-lg shadow-md p-4 flex flex-col gap-3 border border-blue-400/20 w-full max-w-md mx-auto">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xl">🕒</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-6">
          {/* Active Streaks */}
          <section className="bg-white rounded-lg shadow-md p-4 flex flex-col gap-2 border border-primary/20">
