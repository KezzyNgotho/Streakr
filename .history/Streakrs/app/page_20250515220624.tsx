...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-gray-100 flex flex-col">
      ...
      {/* Bottom Tab Bar - Home only, centered */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-lg max-w-md mx-auto w-full flex justify-center py-2">
        <button
          className={`flex flex-col items-center flex-1 py-1 text-primary font-bold`}
