      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          {completedStreaks.length > 0 && (
            <section className="bg-white rounded-lg shadow-md p-4 flex flex-col gap-2 border border-green-400/20">
              <div className="flex items-center mb-2">
        ...
        <div className="flex flex-col gap-6">
          {/* NFT Badge Preview */}
          <section className="bg-white rounded-lg shadow-md p-4 flex flex-col gap-2 border border-orange-400/20">
            <div className="flex items-center mb-2">
          ...
          <section className="bg-white rounded-lg shadow-md p-4 flex flex-col gap-2 border border-blue-400/20">
            <div className="flex items-center mb-2">
