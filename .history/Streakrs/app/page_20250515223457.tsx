...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-gray-100 flex">
      {/* Sidebar Navigation */}
      <aside className="fixed top-0 left-0 h-screen w-20 md:w-56 bg-white/80 backdrop-blur-md shadow-2xl border-r border-gray-200 flex flex-col items-center py-6 z-50">
        {/* Profile at the top */}
        <button
      ...
      <div className="flex-1 ml-20 md:ml-56 w-full max-w-7xl mx-auto">
