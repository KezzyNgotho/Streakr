...
function HomePage() {
  ...
  const mobileWelcomeCard = (
    <div className="flex md:hidden flex-row items-center gap-3 px-4 py-3 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl shadow-lg w-fit max-w-xs ml-2 mt-2">
      <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-2xl shadow border-2 border-white">
        {avatar}
      </div>
  ...
  const desktopTopRow = (
    <div className="hidden md:flex flex-row items-center mt-4 mb-8 w-full gap-4 justify-between px-5 py-4 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl shadow-lg">
      {/* Avatar */}
      <div className="w-14 h-14 rounded-full bg-white flex items-center justify-center text-3xl shadow border-2 border-white mr-4">
        {avatar}
      </div>
      {/* Welcome text and XP */}
  ...
  return (
    <>
      ...
      {/* Quick Actions Row */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
        <button className="w-full px-4 py-2 rounded-lg bg-primary text-white font-semibold shadow-lg hover:bg-primary/90 transition focus:outline-none focus:ring-2 focus:ring-primary">+ Add Streak</button>
        ...
        <div className="flex flex-col gap-6">
          ...
          <section className="bg-white rounded-2xl shadow-lg p-5 flex flex-col gap-3 border border-primary/10 text-xs">
            <div className="flex items-center mb-2">
              ...
              <button className="ml-auto px-3 py-1 rounded-lg bg-secondary text-gray-900 text-xs font-semibold hover:bg-secondary/80 transition shadow focus:outline-none focus:ring-2 focus:ring-secondary">+ Add</button>
            </div>
