  ...
  return (
    <aside
      className={`fixed top-0 left-0 h-screen z-50 transition-all duration-300
        ${expanded ? "w-56" : "w-16"}
        bg-gradient-to-b from-white/80 to-gray-100/60 dark:from-gray-900/90 dark:to-gray-800/80 border-r border-primary/30 flex flex-col
...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-gray-100 flex">
      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarExpanded ? "ml-16 md:ml-56" : "ml-16"} w-full max-w-7xl mx-auto ${darkMode ? "bg-gray-900 text-white" : ""}`}> 
