  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-gray-100 flex">
      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? "ml-20 md:ml-56" : "ml-0 md:ml-20"} w-full max-w-7xl mx-auto`}> 
        ...
        <header className="flex items-center justify-end w-full px-4 py-4 md:py-6 relative gap-4">
          {/* Notification bell */}
          <button
          ...
          >
            <span className="material-icons text-2xl text-gray-700">notifications</span>
          ...
          <AnimatePresence>
            {notificationsOpen && (
              <motion.div
                ...
                className="absolute right-20 top-16 bg-white rounded-xl shadow-lg border border-gray-100 py-2 w-72 z-50 flex flex-col"
              >
