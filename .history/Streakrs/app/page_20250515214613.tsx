...
function HomePage() {
  ...
  const bestStreak = streaks.reduce((max, s) => Math.max(max, s.best || s.count), 0);
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-2 sm:px-4 py-8 pb-8 flex flex-col gap-6">
      ...
      <div className="flex gap-2 mb-2">
        <button className="flex-1 px-4 py-2 rounded-lg bg-primary text-white font-semibold shadow hover:bg-primary/90 transition" onClick={() => setShowAdd(true)}>
          + Add Streak
        </button>
        {eligibleStreak && (
          <button className="flex-1 px-4 py-2 rounded-lg bg-orange-400 text-white font-semibold shadow hover:bg-orange-500 transition" onClick={() => handleMint(eligibleStreak.id)}>
            Claim NFT
          </button>
        )}
        <button className="flex-1 px-4 py-2 rounded-lg bg-secondary text-gray-900 font-semibold shadow hover:bg-secondary/80 transition" onClick={handleShare}>
          Share Progress
        </button>
      </div>
      ...
      {/* Active Streaks */}
      <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white rounded-2xl shadow-xl p-5 flex flex-col gap-2 border-t-4 border-primary/80 mb-2">
      ...
      {completedStreaks.length > 0 && (
        <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="bg-white rounded-2xl shadow-xl p-5 flex flex-col gap-2 border-t-4 border-green-400/80 mb-2">
          <div className="flex items-center mb-1">
      ...
      {/* NFT Badge Preview */}
      <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-white rounded-2xl shadow-xl p-5 flex flex-col gap-2 border-t-4 border-orange-400/80 mb-2">
        <div className="flex items-center mb-1">
      ...
      <section className="bg-white rounded-2xl shadow-xl p-5 flex flex-col gap-2 border-t-4 border-blue-400/80 mb-2">
        <div className="flex items-center mb-1">
