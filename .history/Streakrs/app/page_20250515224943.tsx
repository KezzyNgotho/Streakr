  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-gray-100 flex">
      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? "ml-20 md:ml-56" : "ml-0 md:ml-20"} w-full max-w-7xl mx-auto`}> 
        ...
        <header className="flex items-center justify-between w-full px-4 py-4 md:py-6 relative gap-4 bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-100">
          {/* Page title or search bar (optional) */}
          <div className="flex-1 flex items-center">
            {/* Example: Page title (can be dynamic) */}
