...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-gray-100 flex flex-col">
      {/* Remove hero section from here. Only layout, main content, and nav remain. */}
...
function HomePage() {
  ...
  return (
    <>
      ...
      <div className="w-full flex justify-center mt-4 mb-2">
        <div className="flex items-center gap-4 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl shadow-lg px-5 py-3 max-w-xl w-full">
          ...
          <div className="flex-1">
            ...
            <div className="text-xs text-gray-600 mb-1">Level {level} • {xp} XP</div>
      ...
      {/* Footer/Branding */}
      <footer className="w-full bg-gray-900 text-white py-6 mt-8 flex justify-center items-center shadow-inner">
        <a
          href="https://celo.org/"
          target="_blank"
