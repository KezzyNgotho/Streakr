...
function TopBar({ avatar, profileDropdown, setProfileDropdown, profileBtnRef, notificationsOpen, setNotificationsOpen, notificationsBtnRef, unreadNotifications, notifications }: TopBarProps) {
  return (
    <div className="sticky top-0 left-0 w-full h-14 z-[100] flex items-center justify-between px-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 shadow-lg transition-all duration-200">
      {/* Left: App logo */}
