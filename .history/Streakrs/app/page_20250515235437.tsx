  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center mb-4">
        <div className="bg-white rounded-md shadow-sm p-3 flex flex-col items-center w-full max-w-sm mx-auto border border-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {/* Quick Links */}
        <div className="bg-white rounded-md shadow-sm p-3 flex flex-col gap-2 border border-primary/20 w-full max-w-sm mx-auto">
        ...
        {/* Tips & Motivation */}
        <div className="bg-white rounded-md shadow-sm p-3 flex flex-col gap-2 border border-secondary/20 w-full max-w-sm mx-auto">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xl">💡</span>
        ...
        {/* Recent Activity */}
        <div className="bg-white rounded-md shadow-sm p-3 flex flex-col gap-2 border border-blue-400/20 w-full max-w-sm mx-auto">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xl">🕒</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-6">
          {/* Active Streaks */}
          <section className="bg-white rounded-md shadow-sm p-3 flex flex-col gap-2 border border-primary/20">
          ...
          {completedStreaks.length > 0 && (
            <section className="bg-white rounded-md shadow-sm p-3 flex flex-col gap-2 border border-green-400/20">
              <div className="flex items-center mb-2">
        ...
        <div className="flex flex-col gap-6">
          {/* NFT Badge Preview */}
          <section className="bg-white rounded-md shadow-sm p-3 flex flex-col gap-2 border border-orange-400/20">
            <div className="flex items-center mb-2">
          ...
          <section className="bg-white rounded-md shadow-sm p-3 flex flex-col gap-2 border border-blue-400/20">
            <div className="flex items-center mb-2">
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      ...
      <div className="grid grid-cols-2 gap-4 w-full max-w-xs mb-6">
        <div className="bg-white rounded-md shadow-sm p-3 flex flex-col items-center">
          <span className="text-lg font-bold text-primary">{streaks.length}</span>
          <span className="text-xs text-gray-900">Active</span>
        </div>
        <div className="bg-white rounded-md shadow-sm p-3 flex flex-col items-center">
