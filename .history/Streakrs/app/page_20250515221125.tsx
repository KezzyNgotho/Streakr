...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-gray-100 flex flex-col">
      ...
      {/* Bottom Tab Bar - Home, Gallery, Profile */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-lg max-w-md mx-auto w-full flex justify-around py-2">
        ...
        <button
          className={`flex flex-col items-center flex-1 py-1 ${activeTab === "gallery" ? "text-orange-500 font-bold" : "text-gray-500"}`}
        ...
        <button
          className={`flex flex-col items-center flex-1 py-1 ${activeTab === "profile" ? "text-blue-600 font-bold" : "text-gray-500"}`}
...
function ProfilePage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      <span className="material-icons text-5xl text-blue-500 mb-2">person</span>
      <h2 className="text-2xl font-bold mb-2">Profile</h2>
      <p className="text-gray-700">Your profile, stats, and settings will appear here.</p>
    </div>
  );
}
...
function GalleryPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <p className="text-gray-700">All your earned NFT badges will be displayed here.</p>
    </div>
  );
}
