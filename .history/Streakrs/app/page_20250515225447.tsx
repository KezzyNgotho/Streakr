  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-gray-100 flex">
      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? "ml-20 md:ml-56" : "ml-0 md:ml-20"} w-full max-w-7xl mx-auto`}> 
        {/* Top row: notification, profile, welcome card */}
        <div className="flex flex-row items-start gap-4 w-full px-4 pt-6 md:pt-8">
          {/* Notification bell */}
            ...
            <AnimatePresence>
              {notificationsOpen && (
                <motion.div
                  ...
                  className="absolute left-0 top-12 bg-white rounded-xl shadow-lg border border-gray-100 py-2 w-72 z-50 flex flex-col"
            ...
            <AnimatePresence>
              {profileDropdown && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0, scale: 1 }}
                  exit={{ opacity: 0, y: -10, scale: 0.95 }}
                  className="absolute left-0 top-12 bg-white rounded-xl shadow-lg border border-gray-100 py-2 w-44 z-50 flex flex-col"
                >
          ...
          {/* Welcome card */}
          {activeTab === "home" && (
            <div className="max-w-xl w-full ml-4">
