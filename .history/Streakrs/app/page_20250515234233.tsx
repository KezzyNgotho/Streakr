...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-gray-100 flex">
      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarExpanded ? "ml-16 md:ml-40" : "ml-16"} w-full max-w-7xl mx-auto ${darkMode ? "bg-gray-900 text-white" : ""} pt-14`}> 
...
function HomePage() {
  ...
  const topRow = (
    <div className="flex flex-row items-center justify-between mt-2 mb-4 gap-4">
      {/* Welcome card left */}
      <div className="flex items-center gap-4 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl shadow-lg px-5 py-3">
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto mb-6">
        {/* Quick Links */}
        <div className="bg-white rounded-2xl shadow p-5 flex flex-col gap-3 border-t-4 border-primary/60">
        ...
        {/* Tips & Motivation */}
        <div className="bg-white rounded-2xl shadow p-5 flex flex-col gap-3 border-t-4 border-secondary/60">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xl">💡</span>
        ...
        {/* Recent Activity */}
        <div className="bg-white rounded-2xl shadow p-5 flex flex-col gap-3 border-t-4 border-blue-400/60">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xl">🕒</span>
